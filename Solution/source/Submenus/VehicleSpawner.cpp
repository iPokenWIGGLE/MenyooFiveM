...
#pragma region vehicle bmps
		...
		std::vector<VehBmpSprite> vVehicleBmps{
			...
			//Diamond Casino Heist DLC - Poken
			...
			//Criminal Enterprises DLC - Poken
			...
			{ VEHICLE_TENF, "lgm_dlc_sum2", "tenf"},
